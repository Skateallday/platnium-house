...
<div class="container">
    <div class="row">
        <div class="col-lg-6">
            ...
            <h4>G44 3DL<h4>
            <h5>0141 266 0098</h5>
            <a href="mailto:office@platinum-house.co.uk"><p>office@platinum-house.co.uk</p></a>
        </div>
        <div class="col-lg-6">
